            ...
            if h.lower().startswith("content-length:"):
                try:
                   content_length = int(h.split(":", 1)[1].strip())
                    ...
                    raise ConnectionError("Content-length inválido en headers")
...
class Server:
    ...
    def recibir_http(self, conn):
        ...
        if content_length is None:  
            raise ConnectionError("No se encontró Content-Length en headers")
    ...
    def serve(self):
        ...
        while True:
            ...
            conn.settimeout(60) #timeout de 60s en conexiones aceptadas
